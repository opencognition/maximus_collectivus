  ...
  def create
    ...
    respond_to do |format|
      if @role_permission.save
        format.html { redirect_to @role_permission, notice: 'RolePermission was successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      if @role_permission.update_attributes(params[:role_permission])
        format.html { redirect_to @role_permission, notice: 'RolePermission was successfully updated.' }
